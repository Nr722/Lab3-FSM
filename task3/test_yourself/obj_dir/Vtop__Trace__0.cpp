...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        bufp->chgBit(oldp+0,(vlSelf->top__DOT__address));
        bufp->chgSData(oldp+1,(vlSelf->top__DOT__topclktick__DOT__count),16);
        bufp->chgIData(oldp+2,(vlSelf->top__DOT__topf1_fsm__DOT__current_state),32);
        bufp->chgIData(oldp+3,(((IData)(vlSelf->top__DOT__address)
