...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+8,"N", false,-1, 15,0);
    tracep->declBus(c+9,"out", false,-1, 7,0);
    tracep->declBit(c+1,"address", false,-1);
    tracep->pushNamePrefix("topclktick ");
    ...
    tracep->pushNamePrefix("topf1_fsm ");
    tracep->declBit(c+5,"clk", false,-1);
    tracep->declBit(c+6,"rst", false,-1);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->fullBit(oldp+1,(vlSelf->top__DOT__address));
    bufp->fullSData(oldp+2,(vlSelf->top__DOT__topclktick__DOT__count),16);
    bufp->fullIData(oldp+3,(vlSelf->top__DOT__topf1_fsm__DOT__current_state),32);
    bufp->fullIData(oldp+4,(((IData)(vlSelf->top__DOT__address)
                              ? (((((((((0U == vlSelf->top__DOT__topf1_fsm__DOT__current_state) 
                                  ...
                                  ? ((0U == vlSelf->top__DOT__topf1_fsm__DOT__current_state)
                                      ? 1U : ((1U == vlSelf->top__DOT__topf1_fsm__DOT__current_state)
                                               ? 2U
                                               : ((2U 
                                                   ...
                                                   ((4U 
                                                    ...
                                                    ((5U 
                                                     ...
                                                     ((6U 
                                                       ...
                                                       ? 7U
                                                       : 8U)))))))
                                  : 0U) : vlSelf->top__DOT__topf1_fsm__DOT__current_state)),32);
